...
function send_email($to, $subject, $bodyHtml, $withCc = false)
{
    ...
    try {
        ...
        $mail->CharSet = 'UTF-8';
        $mail->Timeout = 60; // laisse le temps à une connexion lente d'aboutir plutôt que d'échouer silencieusement
...
// Notifie tous les comptes admin (utilisée pour nouvelle demande / relance).
